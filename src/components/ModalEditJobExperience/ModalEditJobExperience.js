...
const ModalEditJobExperience = (props) => {
  const serviceArray = [];
  ...
  return (
    <ModalStyled
      ...
      size="lg"
      centered
      show={gContext.editJobExperienceModalVisible}
      onHide={gContext.toggleEditJobExperienceModal}
    >
                ...
                <form action="/" onSubmit={props.onSubmit}>
                  <div className="form-group">
                    ...
                    <input
                      ...
                      id="descripcion"
                      value={props.jobData.descripcion}
                        ...
                        <div className="col-12 p-0 pr-2">
                          <div className="form-group">
                            ...
                            <input
                              ...
                              id="fecha_inicio"
                              value={props.jobData.fecha_inicio}
                              onChange={props.onChange}
                              autoComplete="off"
                            />
                          </div>
...
export default ModalEditJobExperience;
