        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 2;
              _context.next = 5;
              return _services_auth_service__WEBPACK_IMPORTED_MODULE_11__["default"].register(state.nombre, state.apellido, state.email, state.password, checkedA);
